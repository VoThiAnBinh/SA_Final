...
negative_words = ['kém', 'tệ', 'buồn', 'chán', 'chật_chội', 'không_sạch', 'cũ_kỹ', 'ổn_trừ', 'tạm', 'kém_chất_lượng', 
                  'không_thích', 'không_ổn', 'không_hợp', 'không_đáng_tin_cậy', 'không_chuyên_nghiệp', 'không_phản_hồi', 'không_an_toàn', 
                  'không_phù_hợp', 'không_thân_thiện', 'không_linh_hoạt', 'không_đáng_giá', 'không_ấn_tượng', 'không_tốt', 'chậm', 'khó_khăn', 
                  'phức_tạp', 'dở_xô', 'xuống_cấp', 'hỏng', 'ướt', 'cũ', 'chật', 'không_làm', 'ồn_làm', 'khó_chịu', 'gây_khó_dễ', 'rườm_rà', 
                  'thất_bại', 'tồi_tệ', 'khó_xử', 'không_thể_chấp_nhận', 'tồi_tệ', 'không_rõ_ràng', 'không_chắc_chắn', 'rối_rắm', 'không_tiện_lợi', 
                  'không_đáng_tiền', 'chưa_đẹp', 'không_đẹp', 'tồi', 'xấu', 'không_hài_lòng', 'bẩn', 'khó_chịu', 'không_sạch_sẽ', 'không_thoải_mái', 
                  'không_đáng', 'quá_tệ', 'rất_tệ', 'thất_vọng', 'chán', 'tệ_hại', 'kinh_khủng', 'khủng_khiếp', 'không_ưng_ý', 'ổn', 'hơi_xa', 'trừ', 
                  'hơi_dơ', 'trơn', 'té', 'dột_trần', 'dột', 'ẩm_mócdơ', 'không_hoạt_động', 'ẩm_mốc', 'bất_tiện', 'không_thấy', 'chờ', 'muỗi', 'thái_độ', 
                  'hư', 'nóng', 'xuống_cấp', 'yếu', 'không_tư_vấn', 'kiểm_lâu', 'không_lại', 'cũ_kỷ', 'không_dọn', 'gián', 'đông', 'phòng_không', 'sự_cố', 
                  'bảo_đợi', 'không_xứng', 'nghèo', 'ồn_ào', 'dơ_sàn', 'bí', 'không_đa_dạng', 'khiếu_nại', 'đòi', 'lèo_tèo', 'đau_đầu', 'sót', 'nâng_cấp', 
                  'không_ưng', 'hôi', 'dở', 'cúp', 'tắc', 'ổn_trừ', 'chật_chội', 'ồn', 'không_thông_báo', 'không_hài_lòng', 'kẹt', 'đông_kẹt', 'hứa', 
                  'chập_chờn', 'không_nhiệt_tình', 'không_chào_đón', 'thờ_ơ', 'cứng_nhắc', 'không_đúng', 'đắt', 'muộn', 'không_đủ', 'không_giải_quyết', 
                  'đông_đúc', 'chờ_đợi', 'lâu']

positive_words = ['thích', 'tốt', 'xuất_sắc', 'tuyệt_vời', 'tuyệt_hảo', 'đẹp', 'ổn', 'ngon', 'hài_lòng', 'ưng_ý', 'hoàn_hảo', 'chất_lượng', 'thú_vị', 
                  'nhanh', 'tiện_lợi', 'dễ_sử_dụng', 'hiệu_quả', 'ấn_tượng', 'nổi_bật', 'tận_hưởng', 'tốn_ít_thời_gian', 'thân_thiện', 'hấp_dẫn', 
                  'cao_cấp', 'độc_đáo', 'rất_tốt', 'rất_thích', 'tận_tâm', 'đáng_tin_cậy', 'đẳng_cấp', 'hấp_dẫn', 'an_tâm', 'thúc_đẩy', 'cảm_động',
                  'phục_vụ_tốt', 'làm_hài_lòng', 'gây_ấn_tượng', 'nổi_trội', 'sáng_tạo', 'phù_hợp', 'tận_tâm', 'hiếm_có', 'cải_thiện', 'hoà_nhã', 
                  'chăm_chỉ', 'cẩn_thận', 'vui_vẻ', 'sáng_sủa', 'hào_hứng', 'đam_mê', 'vừa_vặn', 'đáng_tiền', 'nhiệt_tình', 'thoải_mái', 'hợp_lý', 
                  'xịn', 'tuyệt', 'đầy_đủ', 'sạch_sẽ', 'rộng_rãi', 'rẻ', 'rộng', 'mát', 'thuận_tiện', 'thuận_lợi', 'tiện', 'lịch_sự', 'tiện', 'chuẩn',
                  'chuyên_nghiệp', 'thuận_lợi', 'đồng_ý', 'hợp_lí', 'duyệt', 'ghé_tiếp', 'chuẩn', 'chấp_nhận']

# Function to classify sentiment based on rules
def classify_sentiment_vietnamese(text):
    ...
    for token in tokens:
        if token in positive_words:
            ...
            negative_score += 1
    # Determine sentiment level based on scores
    if negative_score >= 1:
        return 'Tiêu cực'
...
###### Start
# Customer Feedback Classification section
    ...
    st.write("### Input your comments or feedback")
    user_comment = st.text_area("Let us know your thinking:", "khách sạn tuyệt vời")
    # Display, preprocess, and classify user comments
    if user_comment:
        st.write("##### Your Comments")
        st.write(user_comment)
        # Tokenize the user comment
        tokenized_comment = word_tokenize(user_comment, format='text')
        # Classify the sentiment
        sentiment = classify_sentiment_vietnamese(tokenized_comment)
        st.write("##### Sentiment Classification")
        st.write(f"Sentiment: {sentiment}")
    else:
        st.write("No comments provided yet.")

    # File upload section
    st.write("### Upload Your Data")
    # Display an image
    # st.write("##### csv file with one column named 'Text' ")
    st.image("test_feedback.PNG", caption="csv file with one column named 'Text'")
    uploaded_file = st.file_uploader("Choose a CSV file", type=["csv"])
    if uploaded_file is not None:
        # Read the uploaded CSV file
        data_sentiment = pd.read_csv(uploaded_file)

        st.write("### Data Preview")
        st.write(data_sentiment.head())
        # Preprocess and classify the text column (assuming the text is in a column named 'Text')
        if 'Text' in data_sentiment.columns:
            data_sentiment['Tokenized Text'] = data_sentiment['Text'].apply(lambda x: word_tokenize(x, format='text'))
            data_sentiment['Sentiment'] = data_sentiment['Tokenized Text'].apply(classify_sentiment_vietnamese)
            st.write("### Tokenized and Classified Data")
            st.write(data_sentiment[['Text', 'Tokenized Text', 'Sentiment']].head())
        else:
            st.write("No 'Text' column found in the uploaded file.")        
####### End
